...
while(1):   #infinite loop to iteratively look for new audio
    ...
    try: #per gestire gli errori se qualcosa va storto
        ...
        if(language=="it"):
            ...
            # Open the image file
             image = Image.open("/Users/tempe/Desktop/Griglia1.jpg") #qua ci va il path dell'immagine da mostrare
            # Show the image
            # image.show()
            ...
            image = Image.open("/Users/tempe/Desktop/Griglia1.jpg")
            image.show()  
...
# Crea una finestra
        ...
        photo_image= open_image("/Users/tempe/Desktop/Griglia1.jpg")
